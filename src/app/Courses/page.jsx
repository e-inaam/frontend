...
const Courses = () => {
  ...
  const [courses, setCourses] = useState([
    ...
    },
    {
      ...
      description:
        "Learn JavaScript from scratch and build interactive web applications.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description:
        "Master digital marketing tactics to grow your business online.",
    },
    {
      id: 5,
      ...
      description:
        "Learn Python programming and data analysis for real-world applications.",
      bestseller: true,
    },
    {
      id: 6,
      ...
      description:
        "Master the art of photography with practical techniques and tips.",
    },
  ]);
          ...
          <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">
                Organize, update, and publish {courses.length} courses for your
                platform.
              </p>
            </div>
